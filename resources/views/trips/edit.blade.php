		...
		<div class="col-sm-7 col-sm-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6 panel-title">Editing: {{$trip->title}}</div>
						<div class="pull-right" style="margin-right: 30px;">
							<button class="btn btn-success" type="submit" form="editTripPlan"><i class="fa fa-floppy-o"></i> Save</button>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<div class="row">
						...
						{!! Form::model($trip, ['method' => 'PATCH', 'action' => ['TripPlansController@update', $trip->id], 'id' => 'editTripPlan']) !!}
							@include('trips.form')
						{!! Form::close() !!}
					</div>
				</div>
